...
public class PagingAndSortingHelper {
	...
	public void updateModelAtributes(int pageNum,Page<?> page) {
	...
	public void listEntities(int pageNum,int pageSize,SearchRepository<?,Integer> repo) {
		...
		if (keyword != null) {
     	...
     	updateModelAtributes(pageNum, page);
	}
	...
	public Pageable createPageable(int pageSize, int pageNum) {
		...
		Pageable pageable = PageRequest.of(pageNum - 1,pageSize,sort);//pagenum PageSize,Sort
